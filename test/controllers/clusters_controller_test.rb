...
class ClustersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cluster" do
    assert_difference("Cluster.count") do
      post clusters_url, params: {cluster: {kubeconfig: @cluster.kubeconfig, name: @cluster.name, user_id: @cluster.user_id}}
    end
  ...
  test "should update cluster" do
    patch cluster_url(@cluster), params: {cluster: {kubeconfig: @cluster.kubeconfig, name: @cluster.name, user_id: @cluster.user_id}}
